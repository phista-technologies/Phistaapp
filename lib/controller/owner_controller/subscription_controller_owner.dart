...
class SubscriptionControllerOwner extends GetxController {
  ...
  setOrder() async {
    ...
    await FireStoreUtils.getMyParkingListOwner().then((value) async {
      if (value != null) {
        for (var element in value) {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (BuildContext context) => UsePaypal(
          sandboxMode: paymentModel.value.paypal!.isSandbox == true
              ? false
              : true,
    ...
    final body = jsonEncode({
      ...
      "customer": {
        ...
        "phonenumber": userModel.value.phoneNumber
            .toString(), // Add a real phone number
  ...
  Future webpayment({
    ...
    Map<String, String> requestBody = {
      ...
      "currency": paymentModel.value.orangePay!.isSandbox == true
          ? "OUV"
          : currency,
      "order_id": orderId,
      "amount": amount,
  ...
  Future<String> createPaymentLink({required var amount}) async {
    ...
    final url = Uri.parse(
      paymentModel.value.midtrans!.isSandbox!
