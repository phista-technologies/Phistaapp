...
import 'package:phista/controller/driver_controller/referral_controller.dart';
...
class ReferAndEarnScreen extends StatelessWidget {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              SvgPicture.asset(
                                  "assets/icon/ic_email_share.svg"),
                              const SizedBox(
                                width: 10,
                              ),
                              Expanded(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              SvgPicture.asset(
                                  "assets/icon/ic_friend_join.svg"),
                              const SizedBox(
                                width: 10,
                              ),
                              Expanded(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              SvgPicture.asset(
                                  "assets/icon/ic_eran_reward.svg"),
                              const SizedBox(
                                width: 10,
                              ),
                              Expanded(
  ...
  Future<void> share(ReferralController controller) async {
    ...
    await Share.share(
      "Hey there, thanks for choosing phista. Hope you love our product. If you do, share it with your friends using code ${controller.referralModel.value.referralCode.toString()} and get ${Constant.amountShow(amount: Constant.referralAmount)}.",
    );
  }
}
