...
class LoginScreen extends StatelessWidget {
      ...
      builder: (controller) {
        return Scaffold(
              ...
              child: kIsWeb
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: _buildLoginForm(controller, themeChange, context),
                  ),
                ),
              )
                  : Padding(
          ...
          bottomNavigationBar: kIsWeb
              ? null // Remove bottom navigation bar for web
              : Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 18),
            child: _buildTermsText(themeChange),
          ),
        );
      },
    );
  ...
  Widget _buildLoginForm(LoginController controller, DarkThemeProvider themeChange, BuildContext context) {
    return Form(
      ...
      child: Column(
        ...
        children: [
          if (!kIsWeb) SizedBox(height: Responsive.height(9, context)),
            Align(
            ...
            children: [
              Visibility(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    width: kIsWeb ? double.infinity : Responsive.width(90, context),
          ...
          // Add terms and conditions at the bottom for web
          if (kIsWeb) ...[
            const SizedBox(height: 20),
            _buildTermsText(themeChange),
          ],
        ],
      ),
    );
  ...
  Widget _buildTermsText(DarkThemeProvider themeChange) {
    return Text.rich(
      textAlign: TextAlign.center,
      TextSpan(
