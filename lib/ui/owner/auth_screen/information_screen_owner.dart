                        ...
                        else if ( (controller.userModel.value.loginType != "apple") && controller.passwordController.value.text.isEmpty)
                        {
                          ...
                          if (controller.fromPhoneNumberExist.toString() == "1"){
                            ...
                            print("2");
                              var isValid = await Utils
                                    .getPhoneNumberValidation(
                                    controller.phoneNumberController.value.text.trim(),controller.isoCode,
                                    controller.countryCode.value.text.trim());
                                if(isValid){
                            ...
                            FireStoreUtils.getUserPasswordByEmail(controller.emailController.value.text.trim()).then((credentials)async {
                                          ...
                                          positiveClick: () async {
                                            ...
                                            if(!controller.isFirstTimeDelete){
                                              await FirebaseAuth.instance.currentUser!.delete().then((value) {
                                                ...
                                                controller.signInWithEmailAndPassword(context,controller.emailController.value.text.trim(), password);
                                              });
                                            }else{
                                              controller.signInWithEmailAndPassword(context,controller.emailController.value.text.trim(), password);
                                            }
