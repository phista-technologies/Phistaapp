...
class LoginScreenOwner extends StatelessWidget {
  ...
  Widget _buildLoginForm(LoginControllerOwner controller, DarkThemeProvider themeChange, BuildContext context) {
    return Form(
      ...
      child: Obx(
          ...
          children: [
            ...
            // Terms text only for web
            if (kIsWeb) _buildTermsText(themeChange),
          ],
        ),
      ),
    );
