...
import '../../../controller/owner_controller/otp_controller_owner.dart';
...
import '../app_not_access_screen_owner.dart';
...
class OtpScreenOwner extends StatelessWidget {
  const OtpScreenOwner({super.key});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return GetX<OtpControllerOwner>(
        init: OtpControllerOwner(),
        builder: (controller) {
          return Scaffold(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "We have sent 6-digit code to ${controller.countryCode.value} ${controller.phoneNumber.value} please enter them below"
                                .tr,
                            textAlign: TextAlign.center,
                              ...
                              if (controller.otpController.value.text.length ==
                                ...
                                await FirebaseAuth.instance
                                  ...
                                  if (value.additionalUserInfo!.isNewUser) {
                                    ...
                                    Get.off(const InformationScreenOwner(),
                                        arguments: {
                                          "userModel": userModel,
                                        });
                                  } else {
