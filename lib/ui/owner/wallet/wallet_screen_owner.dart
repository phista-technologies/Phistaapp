...
import '../../../controller/owner_controller/wallet_controller_owner.dart';
import '../../../env.dart';
...
class WalletScreenOwner extends StatelessWidget {
  final bool isBack;

  const WalletScreenOwner({required this.isBack, super.key});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return GetX<WalletControllerOwner>(
        init: WalletControllerOwner(),
        builder: (controller) {
          return Scaffold(
                        ...
                        Center(
                          child: Container(
                            ...
                            child: Column(children: [
                              ...
                              Text(
                                "${"Minimum Withdrawal will be a".tr} ${Constant.amountShow(amount: Constant.minimumAmountToWithdrawal.toString())}"
                                    .tr,
                                style: TextStyle(
                                    fontSize: 12,
                                    fontFamily: AppThemData.medium,
  ...
  paymentMethodDialog(
      BuildContext context, WalletControllerOwner controller, themeChange) {
  ...
  transactionCard(WalletControllerOwner controller, themeChange,
  ...
  cardDecoration(
      WalletControllerOwner controller, String value, themeChange, String image) {
    return Obx(
      () => Column(
        children: [
          const SizedBox(
                              ...
                              await FireStoreUtils.setWithdrawRequest(
                                ...
                                try {
                                  await Utils.sendEmailWithTemplateWithAllPlatForms(
                                    ...
                                    templateId: ENV.templateIdWithdrawRequest,
                                    dynamicTemplateData: {
                                      "ownerName":
                                  ...
                                  log("Exception sending template :- ",
                                      error: e.toString());
                                }
