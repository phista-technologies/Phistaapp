...
import '../../../controller/owner_controller/edit_profile_controller_owner.dart';
...
class EditProfileScreenOwner extends StatelessWidget {
  const EditProfileScreenOwner({super.key});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return GetX<EditProfileControllerOwner>(
      init: EditProfileControllerOwner(),
      builder: (controller) {
        return Scaffold(
  ...
  Widget editView(context, EditProfileControllerOwner controller) {
    return Column(
      children: [
  ...
  buildBottomSheet(
      BuildContext context, EditProfileControllerOwner controller) {
