...
import '../../../controller/owner_controller/setting_controller_owner.dart';
...
import '../choose_language/choose_language_screen_owner.dart';


class SettingScreenOwner extends StatelessWidget {
  const SettingScreenOwner({super.key});
            ...
            body: Padding(
              ...
              child: Column(
                children: [
                  InkWell(
                    onTap: () {
                      Get.to(() => const ChooseLanguageScreenOwner())!.then((value) {
                        if (value == true) {
                          controller.getThem();
                        }
                      });
  ...
  showThem(BuildContext context, SettingControllerOwner controller) {
