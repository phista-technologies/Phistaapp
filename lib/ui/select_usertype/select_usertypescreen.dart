        ...
        return Scaffold(
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/images/SelectUserTypeBGimg.png"),
                fit: BoxFit.fill,
              ),
            ),
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: Get.height/2,left: Get.width/10),
                    child: SizedBox(
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: Get.width/9.7),
                    child: Text(
                  ...
                  SizedBox(height: 40,),
                  Padding(
                    padding: EdgeInsets.only(left: Get.width/12,right:Get.width/15),
                    child: SquareButtonWithOutGradiant(
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: Get.width/12,right:Get.width/15 ),
                    child: SquareButtonWithOutGradiant(
                      title: "Rent my parking space".tr,
                      onPress: () {
          ...
          SingleChildScrollView(
            child: Container(
              ...
              child: Container(
                margin:EdgeInsets.only(left:Get.width/3,right:Get.width/3,top:Get.height/12,bottom:Get.height/12),
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("assets/images/SelectUserTypeBGimg.png"),
                    fit: BoxFit.fill,
