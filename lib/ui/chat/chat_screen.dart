...
import 'package:phista/controller/chat_controller.dart';
import 'package:phista/themes/app_them_data.dart';
import 'package:phista/themes/responsive.dart';
import 'package:phista/ui/chat/model/chat_model.dart';
...
import 'package:phista/widgets/firebase_pagination/src/firestore_pagination.dart';
                              ...
                              suffixIcon: InkWell(
                                  ...
                                  child: Padding(
                                    ...
                                    child: ((controller.receiverUserModel.value.subscriptionExpiryDate != null &&
                                                controller.receiverUserModel.value.subscriptionExpiryDate?.toDate().isBefore(DateTime.now()) == false) ||
                                            controller.receiverUserModel.value.subscriptionPlan?.features?.chat == true)
                                        ? SvgPicture.asset("assets/icon/ic_send.svg")
                                        : Container(
